...
//     try {
//       setLoading(true);
//       const response = await approveInvestmentRequest(user.token, id);
...
function InvestmentPlansCloseManagement() {
  return <div>InvestmentPlansCloseManagement</div>;
}

export default InvestmentPlansCloseManagement;
