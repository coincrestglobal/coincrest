...
function InvestmentCard() {
  ...
  return (
    <div
      className="relative w-full h-auto sm:h-[360px] lg:h-[360px] bg-opacity-70 rounded-xl border-2 border-button text-text-heading px-4 sm:px-6 py-6 sm:py-8 overflow-hidden flex flex-col sm:flex-row items-center justify-center transition-all duration-300
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 px-4 sm:px-16 py-6 md:py-8 lg:py-16 text-center sm:text-left w-full sm:w-fit">
        <h2 className="text-lg sm:text-xl font-semibold mb-3 md:mb-2 text-text-heading">
          For Investors
        </h2>
        <div className="text-sm sm:text-base text-text-heading/80 space-y-2 md:space-y-1">
          ...
          <p className="text-text-heading">
            Expand your team to earn scalable bonuses, directly aligned with
            your team's size and contribution.
          </p>
        </div>
        <button
  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 px-4 sm:px-6 lg:px-32 py-10 sm:py-16">
        {/* Background overlay */}
        <div className="absolute w-[100%] md:w-[70%] lg:w-[70%] max-w-5xl h-[380px] md:h-[350px] lg:h-[290px] rounded-lg overflow-hidden">
