...
const FAQ = () => {
  ...
  return (
    <div className="relative px-96 py-8 space-y-8 text-center text-text-heading">
      <h1 className="text-text-heading text-3xl font-bold flex items-center gap-4 justify-center">
        <span className="text-button text-4xl">««</span>
      ...
      <img
        src="/images/FAQ.png"
        className="absolute opacity-20 translate-x-28 pointer-events-none"
        alt="FAQ background"
      />
      ...
      {/* ✅ Add AnimatePresence + motion.div here */}
            ...
            <div key={index} className="group">
              ...
              <AnimatePresence>
                {activeQuestion === index && (
                  ...
                  >
                    <div className="mt-2 text-gray-300 px-10 pb-4">
                      {item.answer}
                    </div>
                  </motion.div>
                )}
      ...
      <button
        ...
        className="border border-white py-3 px-6 rounded-xl text-text-heading font-semibold bg-button hover:bg-button-hover hover:text-black transition mt-8"
      >
        ASK A QUESTION
      </button>
    </div>
